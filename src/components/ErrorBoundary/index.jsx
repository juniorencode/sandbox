...
export class ErrorBoundary extends Component {
  ...
  render() {
    ...
    return (
      <div className="flex h-screen flex-col items-center justify-center gap-4 bg-app p-8 text-ink">
        <h1 className="text-lg font-semibold text-danger">
          Sandbox hit an error it could not recover from
        </h1>

        <pre className="max-h-48 max-w-2xl overflow-auto rounded border border-line bg-chrome p-3 text-[12px] whitespace-pre-wrap">
        ...
        <div className="flex gap-2">
          <button
            className="rounded bg-raised px-3 py-1.5 text-[13px] hover:bg-raised-hover"
            onClick={this.handleReload}
          >
            Reload
          </button>
          <button
            className="rounded bg-raised px-3 py-1.5 text-[13px] hover:bg-raised-hover disabled:opacity-50"
          ...
          <button
            className="rounded px-3 py-1.5 text-[13px] text-muted hover:text-ink"
        ...
        <p className="max-w-xl text-center text-[12px] text-muted">
